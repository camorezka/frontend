...
var REVEAL_BEFORE_END = 2000; // за сколько мс до остановки раскрывать все крутящиеся подарки
...
function startSpinAnimation(onDone, withStarItem) {
  ...
  function revealAllItems() {
    ...
    for (var idx = 0; idx < track.children.length; idx++) {
      ...
      var revealedHtml = _renderSpinItem(item, true);
      var newEl = document.createElement("div");
      newEl.innerHTML = revealedHtml;
      var newChild = newEl.firstChild;
      if (newChild) el.parentNode.replaceChild(newChild, el);
    }
