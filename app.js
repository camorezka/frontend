...
function cacheCarouselWidth() {
  ...
  if (_carouselTrack && _carouselTrack.scrollWidth > 0) {
    ...
    _carouselTrack.style.willChange = "transform"; // GPU-слой заранее
  }
}
...
function tickCarousel() {
  if (!_carouselTrack) {
    ...
    if (_carouselTrack.scrollWidth > 0) carouselHalf = _carouselTrack.scrollWidth / 2;
  }
  carouselPos += carouselSpeed;
  if (carouselHalf > 0 && carouselPos >= carouselHalf) carouselPos -= carouselHalf;
  _carouselTrack.style.transform = "translate3d(-" + carouselPos + "px,0,0)";
